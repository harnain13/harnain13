# 👋 Hi, I'm Harnain Kaur Sardarni 
### Data Scientist | AI & ML Engineer | Data Analyst | Business Analyst

I am a detail-oriented **Data Scientist** focused on uncovering hidden patterns and transforming raw data into strategic insights. With a Master's from **DePaul University**, I specialize in building end-to-end AI solutions—from multi-modal emotion detection to predictive analytics for autonomous systems.
...
### 🎯 2026 Focus
- 🌱 **Currently Learning:** MLOps pipelines and Agentic AI workflows.
- 🔭 **Current Project:** Building a RAG-based AI Assistant for Healthcare data.
- ⚡ **Goal:** Leveraging Generative AI to solve real-world agricultural and health challenges.
